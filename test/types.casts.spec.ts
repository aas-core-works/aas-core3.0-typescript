...
// dev_scripts/test_codegen/generate_test_for_casts.py
...
test("casts over an instance of Extension", () => {
  ...
  expect(AasTypes.isAbstractLangString(theExtension)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theExtension)).toBeNull();

  expect(AasTypes.isLangStringNameType(theExtension)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theExtension)).toBeNull();

  expect(AasTypes.isLangStringTextType(theExtension)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theExtension)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theExtension)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theExtension)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theExtension)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theExtension)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theExtension)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theExtension)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theExtension)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theExtension)).toBeNull();
...
test("casts over an instance of AdministrativeInformation", () => {
  ...
  expect(AasTypes.isAbstractLangString(theAdministrativeInformation)).toStrictEqual(
    false
  );
  expect(AasTypes.asAbstractLangString(theAdministrativeInformation)).toBeNull();

  expect(AasTypes.isLangStringNameType(theAdministrativeInformation)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringNameType(theAdministrativeInformation)).toBeNull();

  expect(AasTypes.isLangStringTextType(theAdministrativeInformation)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringTextType(theAdministrativeInformation)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theAdministrativeInformation)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theAdministrativeInformation)).toBeNull();
...
test("casts over an instance of Qualifier", () => {
  ...
  expect(AasTypes.isAbstractLangString(theQualifier)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theQualifier)).toBeNull();

  expect(AasTypes.isLangStringNameType(theQualifier)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theQualifier)).toBeNull();

  expect(AasTypes.isLangStringTextType(theQualifier)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theQualifier)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theQualifier)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theQualifier)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theQualifier)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theQualifier)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theQualifier)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theQualifier)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theQualifier)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theQualifier)).toBeNull();
...
test("casts over an instance of AssetAdministrationShell", () => {
  ...
  expect(AasTypes.isAbstractLangString(theAssetAdministrationShell)).toStrictEqual(
    false
  );
  expect(AasTypes.asAbstractLangString(theAssetAdministrationShell)).toBeNull();

  expect(AasTypes.isLangStringNameType(theAssetAdministrationShell)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringNameType(theAssetAdministrationShell)).toBeNull();

  expect(AasTypes.isLangStringTextType(theAssetAdministrationShell)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringTextType(theAssetAdministrationShell)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theAssetAdministrationShell)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theAssetAdministrationShell)).toBeNull();
...
test("casts over an instance of AssetInformation", () => {
  ...
  expect(AasTypes.isAbstractLangString(theAssetInformation)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theAssetInformation)).toBeNull();

  expect(AasTypes.isLangStringNameType(theAssetInformation)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theAssetInformation)).toBeNull();

  expect(AasTypes.isLangStringTextType(theAssetInformation)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theAssetInformation)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theAssetInformation)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theAssetInformation)).toBeNull();
  ...
  expect(AasTypes.isLangStringShortNameTypeIec61360(theAssetInformation)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringShortNameTypeIec61360(theAssetInformation)).toBeNull();

  expect(
    AasTypes.isLangStringDefinitionTypeIec61360(theAssetInformation)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theAssetInformation)).toBeNull();
...
test("casts over an instance of Resource", () => {
  ...
  expect(AasTypes.isAbstractLangString(theResource)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theResource)).toBeNull();

  expect(AasTypes.isLangStringNameType(theResource)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theResource)).toBeNull();

  expect(AasTypes.isLangStringTextType(theResource)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theResource)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theResource)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theResource)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theResource)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theResource)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theResource)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theResource)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theResource)).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theResource)).toBeNull();
...
test("casts over an instance of SpecificAssetId", () => {
  ...
  expect(AasTypes.isAbstractLangString(theSpecificAssetId)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theSpecificAssetId)).toBeNull();

  expect(AasTypes.isLangStringNameType(theSpecificAssetId)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theSpecificAssetId)).toBeNull();

  expect(AasTypes.isLangStringTextType(theSpecificAssetId)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theSpecificAssetId)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theSpecificAssetId)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theSpecificAssetId)).toBeNull();
  ...
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theSpecificAssetId)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theSpecificAssetId)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringShortNameTypeIec61360(theSpecificAssetId)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theSpecificAssetId)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theSpecificAssetId)).toBeNull();
...
test("casts over an instance of Submodel", () => {
  ...
  expect(AasTypes.isAbstractLangString(theSubmodel)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theSubmodel)).toBeNull();

  expect(AasTypes.isLangStringNameType(theSubmodel)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theSubmodel)).toBeNull();

  expect(AasTypes.isLangStringTextType(theSubmodel)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theSubmodel)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theSubmodel)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theSubmodel)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theSubmodel)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theSubmodel)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theSubmodel)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theSubmodel)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theSubmodel)).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theSubmodel)).toBeNull();
...
test("casts over an instance of RelationshipElement", () => {
  ...
  expect(AasTypes.isHasKind(theRelationshipElement)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theRelationshipElement)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theRelationshipElement)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theRelationshipElement)).toBeNull();

  expect(AasTypes.isLangStringNameType(theRelationshipElement)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theRelationshipElement)).toBeNull();

  expect(AasTypes.isLangStringTextType(theRelationshipElement)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theRelationshipElement)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theRelationshipElement)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theRelationshipElement)).toBeNull();
  ...
  expect(AasTypes.asLangStringShortNameTypeIec61360(theRelationshipElement)).toBeNull();
...
test("casts over an instance of SubmodelElementList", () => {
  ...
  expect(AasTypes.isHasKind(theSubmodelElementList)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theSubmodelElementList)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theSubmodelElementList)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theSubmodelElementList)).toBeNull();

  expect(AasTypes.isLangStringNameType(theSubmodelElementList)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theSubmodelElementList)).toBeNull();

  expect(AasTypes.isLangStringTextType(theSubmodelElementList)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theSubmodelElementList)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theSubmodelElementList)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theSubmodelElementList)).toBeNull();
  ...
  expect(AasTypes.asLangStringShortNameTypeIec61360(theSubmodelElementList)).toBeNull();
...
test("casts over an instance of SubmodelElementCollection", () => {
  ...
  expect(AasTypes.isHasKind(theSubmodelElementCollection)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theSubmodelElementCollection)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theSubmodelElementCollection)).toStrictEqual(
    false
  );
  expect(AasTypes.asAbstractLangString(theSubmodelElementCollection)).toBeNull();

  expect(AasTypes.isLangStringNameType(theSubmodelElementCollection)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringNameType(theSubmodelElementCollection)).toBeNull();

  expect(AasTypes.isLangStringTextType(theSubmodelElementCollection)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringTextType(theSubmodelElementCollection)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theSubmodelElementCollection)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theSubmodelElementCollection)).toBeNull();
...
test("casts over an instance of Property", () => {
  ...
  expect(AasTypes.isHasKind(theProperty)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theProperty)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theProperty)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theProperty)).toBeNull();

  expect(AasTypes.isLangStringNameType(theProperty)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theProperty)).toBeNull();

  expect(AasTypes.isLangStringTextType(theProperty)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theProperty)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theProperty)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theProperty)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theProperty)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theProperty)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theProperty)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theProperty)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theProperty)).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theProperty)).toBeNull();
...
test("casts over an instance of MultiLanguageProperty", () => {
  ...
  expect(AasTypes.isHasKind(theMultiLanguageProperty)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theMultiLanguageProperty)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theMultiLanguageProperty)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theMultiLanguageProperty)).toBeNull();

  expect(AasTypes.isLangStringNameType(theMultiLanguageProperty)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theMultiLanguageProperty)).toBeNull();

  expect(AasTypes.isLangStringTextType(theMultiLanguageProperty)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theMultiLanguageProperty)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theMultiLanguageProperty)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theMultiLanguageProperty)).toBeNull();
...
test("casts over an instance of Range", () => {
  ...
  expect(AasTypes.isHasKind(theRange)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theRange)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theRange)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theRange)).toBeNull();

  expect(AasTypes.isLangStringNameType(theRange)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theRange)).toBeNull();

  expect(AasTypes.isLangStringTextType(theRange)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theRange)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theRange)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theRange)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theRange)).toStrictEqual(false);
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theRange)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theRange)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theRange)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theRange)).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theRange)).toBeNull();
...
test("casts over an instance of ReferenceElement", () => {
  ...
  expect(AasTypes.isHasKind(theReferenceElement)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theReferenceElement)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theReferenceElement)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theReferenceElement)).toBeNull();

  expect(AasTypes.isLangStringNameType(theReferenceElement)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theReferenceElement)).toBeNull();

  expect(AasTypes.isLangStringTextType(theReferenceElement)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theReferenceElement)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theReferenceElement)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theReferenceElement)).toBeNull();
  ...
  expect(AasTypes.isLangStringShortNameTypeIec61360(theReferenceElement)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringShortNameTypeIec61360(theReferenceElement)).toBeNull();

  expect(
    AasTypes.isLangStringDefinitionTypeIec61360(theReferenceElement)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theReferenceElement)).toBeNull();
...
test("casts over an instance of Blob", () => {
  ...
  expect(AasTypes.isHasKind(theBlob)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theBlob)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theBlob)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theBlob)).toBeNull();

  expect(AasTypes.isLangStringNameType(theBlob)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theBlob)).toBeNull();

  expect(AasTypes.isLangStringTextType(theBlob)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theBlob)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theBlob)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theBlob)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theBlob)).toStrictEqual(false);
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theBlob)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theBlob)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theBlob)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theBlob)).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theBlob)).toBeNull();
...
test("casts over an instance of File", () => {
  ...
  expect(AasTypes.isHasKind(theFile)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theFile)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theFile)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theFile)).toBeNull();

  expect(AasTypes.isLangStringNameType(theFile)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theFile)).toBeNull();

  expect(AasTypes.isLangStringTextType(theFile)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theFile)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theFile)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theFile)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theFile)).toStrictEqual(false);
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theFile)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theFile)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theFile)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theFile)).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theFile)).toBeNull();
...
test("casts over an instance of AnnotatedRelationshipElement", () => {
  ...
  expect(AasTypes.isHasKind(theAnnotatedRelationshipElement)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theAnnotatedRelationshipElement)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theAnnotatedRelationshipElement)).toStrictEqual(
    false
  );
  expect(AasTypes.asAbstractLangString(theAnnotatedRelationshipElement)).toBeNull();

  expect(AasTypes.isLangStringNameType(theAnnotatedRelationshipElement)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringNameType(theAnnotatedRelationshipElement)).toBeNull();

  expect(AasTypes.isLangStringTextType(theAnnotatedRelationshipElement)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringTextType(theAnnotatedRelationshipElement)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theAnnotatedRelationshipElement)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theAnnotatedRelationshipElement)).toBeNull();
...
test("casts over an instance of Entity", () => {
  ...
  expect(AasTypes.isHasKind(theEntity)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theEntity)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theEntity)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theEntity)).toBeNull();

  expect(AasTypes.isLangStringNameType(theEntity)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theEntity)).toBeNull();

  expect(AasTypes.isLangStringTextType(theEntity)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theEntity)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theEntity)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theEntity)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theEntity)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theEntity)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theEntity)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theEntity)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theEntity)).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theEntity)).toBeNull();
...
test("casts over an instance of EventPayload", () => {
  ...
  expect(AasTypes.isAbstractLangString(theEventPayload)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theEventPayload)).toBeNull();

  expect(AasTypes.isLangStringNameType(theEventPayload)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theEventPayload)).toBeNull();

  expect(AasTypes.isLangStringTextType(theEventPayload)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theEventPayload)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theEventPayload)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theEventPayload)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theEventPayload)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theEventPayload)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theEventPayload)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringShortNameTypeIec61360(theEventPayload)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theEventPayload)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theEventPayload)).toBeNull();
...
test("casts over an instance of BasicEventElement", () => {
  ...
  expect(AasTypes.isHasKind(theBasicEventElement)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theBasicEventElement)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theBasicEventElement)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theBasicEventElement)).toBeNull();

  expect(AasTypes.isLangStringNameType(theBasicEventElement)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theBasicEventElement)).toBeNull();

  expect(AasTypes.isLangStringTextType(theBasicEventElement)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theBasicEventElement)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theBasicEventElement)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theBasicEventElement)).toBeNull();
  ...
  expect(AasTypes.asLangStringShortNameTypeIec61360(theBasicEventElement)).toBeNull();

  expect(
    AasTypes.isLangStringDefinitionTypeIec61360(theBasicEventElement)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theBasicEventElement)).toBeNull();
...
test("casts over an instance of Operation", () => {
  ...
  expect(AasTypes.isHasKind(theOperation)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theOperation)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theOperation)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theOperation)).toBeNull();

  expect(AasTypes.isLangStringNameType(theOperation)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theOperation)).toBeNull();

  expect(AasTypes.isLangStringTextType(theOperation)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theOperation)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theOperation)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theOperation)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theOperation)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theOperation)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theOperation)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theOperation)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theOperation)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theOperation)).toBeNull();
...
test("casts over an instance of OperationVariable", () => {
  ...
  expect(AasTypes.isAbstractLangString(theOperationVariable)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theOperationVariable)).toBeNull();

  expect(AasTypes.isLangStringNameType(theOperationVariable)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theOperationVariable)).toBeNull();

  expect(AasTypes.isLangStringTextType(theOperationVariable)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theOperationVariable)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theOperationVariable)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theOperationVariable)).toBeNull();
  ...
  expect(AasTypes.asLangStringShortNameTypeIec61360(theOperationVariable)).toBeNull();

  expect(
    AasTypes.isLangStringDefinitionTypeIec61360(theOperationVariable)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theOperationVariable)).toBeNull();
...
test("casts over an instance of Capability", () => {
  ...
  expect(AasTypes.isHasKind(theCapability)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theCapability)).toBeNull();
  ...
  expect(AasTypes.isAbstractLangString(theCapability)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theCapability)).toBeNull();

  expect(AasTypes.isLangStringNameType(theCapability)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theCapability)).toBeNull();

  expect(AasTypes.isLangStringTextType(theCapability)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theCapability)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theCapability)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theCapability)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theCapability)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theCapability)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theCapability)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringShortNameTypeIec61360(theCapability)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theCapability)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theCapability)).toBeNull();
...
test("casts over an instance of ConceptDescription", () => {
  ...
  expect(AasTypes.isAbstractLangString(theConceptDescription)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theConceptDescription)).toBeNull();

  expect(AasTypes.isLangStringNameType(theConceptDescription)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theConceptDescription)).toBeNull();

  expect(AasTypes.isLangStringTextType(theConceptDescription)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theConceptDescription)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theConceptDescription)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theConceptDescription)).toBeNull();
  ...
  expect(AasTypes.asLangStringShortNameTypeIec61360(theConceptDescription)).toBeNull();

  expect(
    AasTypes.isLangStringDefinitionTypeIec61360(theConceptDescription)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theConceptDescription)).toBeNull();
...
test("casts over an instance of Reference", () => {
  ...
  expect(AasTypes.isAbstractLangString(theReference)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theReference)).toBeNull();

  expect(AasTypes.isLangStringNameType(theReference)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theReference)).toBeNull();

  expect(AasTypes.isLangStringTextType(theReference)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theReference)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theReference)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theReference)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theReference)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theReference)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theReference)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theReference)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theReference)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theReference)).toBeNull();
...
test("casts over an instance of Key", () => {
  ...
  expect(AasTypes.isAbstractLangString(theKey)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theKey)).toBeNull();

  expect(AasTypes.isLangStringNameType(theKey)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theKey)).toBeNull();

  expect(AasTypes.isLangStringTextType(theKey)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theKey)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theKey)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theKey)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theKey)).toStrictEqual(false);
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theKey)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theKey)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theKey)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theKey)).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theKey)).toBeNull();
...
test("casts over an instance of LangStringNameType", () => {
  const theLangStringNameType = TestCommonJsonization.loadMinimalLangStringNameType();

  expect(AasTypes.isHasSemantics(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asHasSemantics(theLangStringNameType)).toBeNull();

  expect(AasTypes.isExtension(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asExtension(theLangStringNameType)).toBeNull();

  expect(AasTypes.isHasExtensions(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asHasExtensions(theLangStringNameType)).toBeNull();

  expect(AasTypes.isReferable(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asReferable(theLangStringNameType)).toBeNull();

  expect(AasTypes.isIdentifiable(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asIdentifiable(theLangStringNameType)).toBeNull();

  expect(AasTypes.isHasKind(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theLangStringNameType)).toBeNull();

  expect(AasTypes.isHasDataSpecification(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asHasDataSpecification(theLangStringNameType)).toBeNull();

  expect(AasTypes.isAdministrativeInformation(theLangStringNameType)).toStrictEqual(
    false
  );
  expect(AasTypes.asAdministrativeInformation(theLangStringNameType)).toBeNull();

  expect(AasTypes.isQualifiable(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asQualifiable(theLangStringNameType)).toBeNull();

  expect(AasTypes.isQualifier(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asQualifier(theLangStringNameType)).toBeNull();

  expect(AasTypes.isAssetAdministrationShell(theLangStringNameType)).toStrictEqual(
    false
  );
  expect(AasTypes.asAssetAdministrationShell(theLangStringNameType)).toBeNull();

  expect(AasTypes.isAssetInformation(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asAssetInformation(theLangStringNameType)).toBeNull();

  expect(AasTypes.isResource(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asResource(theLangStringNameType)).toBeNull();

  expect(AasTypes.isSpecificAssetId(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asSpecificAssetId(theLangStringNameType)).toBeNull();

  expect(AasTypes.isSubmodel(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asSubmodel(theLangStringNameType)).toBeNull();

  expect(AasTypes.isSubmodelElement(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asSubmodelElement(theLangStringNameType)).toBeNull();

  expect(AasTypes.isRelationshipElement(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asRelationshipElement(theLangStringNameType)).toBeNull();

  expect(AasTypes.isSubmodelElementList(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asSubmodelElementList(theLangStringNameType)).toBeNull();

  expect(AasTypes.isSubmodelElementCollection(theLangStringNameType)).toStrictEqual(
    false
  );
  expect(AasTypes.asSubmodelElementCollection(theLangStringNameType)).toBeNull();

  expect(AasTypes.isDataElement(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asDataElement(theLangStringNameType)).toBeNull();

  expect(AasTypes.isProperty(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asProperty(theLangStringNameType)).toBeNull();

  expect(AasTypes.isMultiLanguageProperty(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asMultiLanguageProperty(theLangStringNameType)).toBeNull();

  expect(AasTypes.isRange(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asRange(theLangStringNameType)).toBeNull();

  expect(AasTypes.isReferenceElement(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asReferenceElement(theLangStringNameType)).toBeNull();

  expect(AasTypes.isBlob(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asBlob(theLangStringNameType)).toBeNull();

  expect(AasTypes.isFile(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asFile(theLangStringNameType)).toBeNull();

  expect(AasTypes.isAnnotatedRelationshipElement(theLangStringNameType)).toStrictEqual(
    false
  );
  expect(AasTypes.asAnnotatedRelationshipElement(theLangStringNameType)).toBeNull();

  expect(AasTypes.isEntity(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asEntity(theLangStringNameType)).toBeNull();

  expect(AasTypes.isEventPayload(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asEventPayload(theLangStringNameType)).toBeNull();

  expect(AasTypes.isEventElement(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asEventElement(theLangStringNameType)).toBeNull();

  expect(AasTypes.isBasicEventElement(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asBasicEventElement(theLangStringNameType)).toBeNull();

  expect(AasTypes.isOperation(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asOperation(theLangStringNameType)).toBeNull();

  expect(AasTypes.isOperationVariable(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asOperationVariable(theLangStringNameType)).toBeNull();

  expect(AasTypes.isCapability(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asCapability(theLangStringNameType)).toBeNull();

  expect(AasTypes.isConceptDescription(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asConceptDescription(theLangStringNameType)).toBeNull();

  expect(AasTypes.isReference(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asReference(theLangStringNameType)).toBeNull();

  expect(AasTypes.isKey(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asKey(theLangStringNameType)).toBeNull();

  expect(AasTypes.isAbstractLangString(theLangStringNameType)).toStrictEqual(true);
  expect(AasTypes.asAbstractLangString(theLangStringNameType)).toStrictEqual(
    theLangStringNameType
  );

  expect(AasTypes.isLangStringNameType(theLangStringNameType)).toStrictEqual(true);
  expect(AasTypes.asLangStringNameType(theLangStringNameType)).toStrictEqual(
    theLangStringNameType
  );

  expect(AasTypes.isLangStringTextType(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theLangStringNameType)).toBeNull();

  expect(AasTypes.isEnvironment(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asEnvironment(theLangStringNameType)).toBeNull();

  expect(AasTypes.isDataSpecificationContent(theLangStringNameType)).toStrictEqual(
    false
  );
  expect(AasTypes.asDataSpecificationContent(theLangStringNameType)).toBeNull();

  expect(AasTypes.isEmbeddedDataSpecification(theLangStringNameType)).toStrictEqual(
    false
  );
  expect(AasTypes.asEmbeddedDataSpecification(theLangStringNameType)).toBeNull();

  expect(AasTypes.isLevelType(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theLangStringNameType)).toBeNull();

  expect(AasTypes.isValueReferencePair(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asValueReferencePair(theLangStringNameType)).toBeNull();

  expect(AasTypes.isValueList(theLangStringNameType)).toStrictEqual(false);
  expect(AasTypes.asValueList(theLangStringNameType)).toBeNull();
  ...
  expect(AasTypes.asLangStringShortNameTypeIec61360(theLangStringNameType)).toBeNull();

  expect(
    AasTypes.isLangStringDefinitionTypeIec61360(theLangStringNameType)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theLangStringNameType)).toBeNull();

  expect(AasTypes.isDataSpecificationIec61360(theLangStringNameType)).toStrictEqual(
    false
  );
  expect(AasTypes.asDataSpecificationIec61360(theLangStringNameType)).toBeNull();
});

test("casts over an instance of LangStringTextType", () => {
  const theLangStringTextType = TestCommonJsonization.loadMinimalLangStringTextType();

  expect(AasTypes.isHasSemantics(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asHasSemantics(theLangStringTextType)).toBeNull();

  expect(AasTypes.isExtension(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asExtension(theLangStringTextType)).toBeNull();

  expect(AasTypes.isHasExtensions(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asHasExtensions(theLangStringTextType)).toBeNull();

  expect(AasTypes.isReferable(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asReferable(theLangStringTextType)).toBeNull();

  expect(AasTypes.isIdentifiable(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asIdentifiable(theLangStringTextType)).toBeNull();

  expect(AasTypes.isHasKind(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theLangStringTextType)).toBeNull();

  expect(AasTypes.isHasDataSpecification(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asHasDataSpecification(theLangStringTextType)).toBeNull();

  expect(AasTypes.isAdministrativeInformation(theLangStringTextType)).toStrictEqual(
    false
  );
  expect(AasTypes.asAdministrativeInformation(theLangStringTextType)).toBeNull();

  expect(AasTypes.isQualifiable(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asQualifiable(theLangStringTextType)).toBeNull();

  expect(AasTypes.isQualifier(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asQualifier(theLangStringTextType)).toBeNull();

  expect(AasTypes.isAssetAdministrationShell(theLangStringTextType)).toStrictEqual(
    false
  );
  expect(AasTypes.asAssetAdministrationShell(theLangStringTextType)).toBeNull();

  expect(AasTypes.isAssetInformation(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asAssetInformation(theLangStringTextType)).toBeNull();

  expect(AasTypes.isResource(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asResource(theLangStringTextType)).toBeNull();

  expect(AasTypes.isSpecificAssetId(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asSpecificAssetId(theLangStringTextType)).toBeNull();

  expect(AasTypes.isSubmodel(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asSubmodel(theLangStringTextType)).toBeNull();

  expect(AasTypes.isSubmodelElement(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asSubmodelElement(theLangStringTextType)).toBeNull();

  expect(AasTypes.isRelationshipElement(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asRelationshipElement(theLangStringTextType)).toBeNull();

  expect(AasTypes.isSubmodelElementList(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asSubmodelElementList(theLangStringTextType)).toBeNull();

  expect(AasTypes.isSubmodelElementCollection(theLangStringTextType)).toStrictEqual(
    false
  );
  expect(AasTypes.asSubmodelElementCollection(theLangStringTextType)).toBeNull();

  expect(AasTypes.isDataElement(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asDataElement(theLangStringTextType)).toBeNull();

  expect(AasTypes.isProperty(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asProperty(theLangStringTextType)).toBeNull();

  expect(AasTypes.isMultiLanguageProperty(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asMultiLanguageProperty(theLangStringTextType)).toBeNull();

  expect(AasTypes.isRange(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asRange(theLangStringTextType)).toBeNull();

  expect(AasTypes.isReferenceElement(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asReferenceElement(theLangStringTextType)).toBeNull();

  expect(AasTypes.isBlob(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asBlob(theLangStringTextType)).toBeNull();

  expect(AasTypes.isFile(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asFile(theLangStringTextType)).toBeNull();

  expect(AasTypes.isAnnotatedRelationshipElement(theLangStringTextType)).toStrictEqual(
    false
  );
  expect(AasTypes.asAnnotatedRelationshipElement(theLangStringTextType)).toBeNull();

  expect(AasTypes.isEntity(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asEntity(theLangStringTextType)).toBeNull();

  expect(AasTypes.isEventPayload(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asEventPayload(theLangStringTextType)).toBeNull();

  expect(AasTypes.isEventElement(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asEventElement(theLangStringTextType)).toBeNull();

  expect(AasTypes.isBasicEventElement(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asBasicEventElement(theLangStringTextType)).toBeNull();

  expect(AasTypes.isOperation(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asOperation(theLangStringTextType)).toBeNull();

  expect(AasTypes.isOperationVariable(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asOperationVariable(theLangStringTextType)).toBeNull();

  expect(AasTypes.isCapability(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asCapability(theLangStringTextType)).toBeNull();

  expect(AasTypes.isConceptDescription(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asConceptDescription(theLangStringTextType)).toBeNull();

  expect(AasTypes.isReference(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asReference(theLangStringTextType)).toBeNull();

  expect(AasTypes.isKey(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asKey(theLangStringTextType)).toBeNull();

  expect(AasTypes.isAbstractLangString(theLangStringTextType)).toStrictEqual(true);
  expect(AasTypes.asAbstractLangString(theLangStringTextType)).toStrictEqual(
    theLangStringTextType
  );

  expect(AasTypes.isLangStringNameType(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theLangStringTextType)).toBeNull();

  expect(AasTypes.isLangStringTextType(theLangStringTextType)).toStrictEqual(true);
  expect(AasTypes.asLangStringTextType(theLangStringTextType)).toStrictEqual(
    theLangStringTextType
  );

  expect(AasTypes.isEnvironment(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asEnvironment(theLangStringTextType)).toBeNull();

  expect(AasTypes.isDataSpecificationContent(theLangStringTextType)).toStrictEqual(
    false
  );
  expect(AasTypes.asDataSpecificationContent(theLangStringTextType)).toBeNull();

  expect(AasTypes.isEmbeddedDataSpecification(theLangStringTextType)).toStrictEqual(
    false
  );
  expect(AasTypes.asEmbeddedDataSpecification(theLangStringTextType)).toBeNull();

  expect(AasTypes.isLevelType(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theLangStringTextType)).toBeNull();

  expect(AasTypes.isValueReferencePair(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asValueReferencePair(theLangStringTextType)).toBeNull();

  expect(AasTypes.isValueList(theLangStringTextType)).toStrictEqual(false);
  expect(AasTypes.asValueList(theLangStringTextType)).toBeNull();
  ...
  expect(AasTypes.asLangStringShortNameTypeIec61360(theLangStringTextType)).toBeNull();

  expect(
    AasTypes.isLangStringDefinitionTypeIec61360(theLangStringTextType)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theLangStringTextType)).toBeNull();

  expect(AasTypes.isDataSpecificationIec61360(theLangStringTextType)).toStrictEqual(
    false
  );
  expect(AasTypes.asDataSpecificationIec61360(theLangStringTextType)).toBeNull();
});
...
test("casts over an instance of Environment", () => {
  ...
  expect(AasTypes.isAbstractLangString(theEnvironment)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theEnvironment)).toBeNull();

  expect(AasTypes.isLangStringNameType(theEnvironment)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theEnvironment)).toBeNull();

  expect(AasTypes.isLangStringTextType(theEnvironment)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theEnvironment)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theEnvironment)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theEnvironment)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theEnvironment)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theEnvironment)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theEnvironment)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringShortNameTypeIec61360(theEnvironment)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theEnvironment)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theEnvironment)).toBeNull();
...
test("casts over an instance of EmbeddedDataSpecification", () => {
  ...
  expect(AasTypes.isAbstractLangString(theEmbeddedDataSpecification)).toStrictEqual(
    false
  );
  expect(AasTypes.asAbstractLangString(theEmbeddedDataSpecification)).toBeNull();

  expect(AasTypes.isLangStringNameType(theEmbeddedDataSpecification)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringNameType(theEmbeddedDataSpecification)).toBeNull();

  expect(AasTypes.isLangStringTextType(theEmbeddedDataSpecification)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringTextType(theEmbeddedDataSpecification)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theEmbeddedDataSpecification)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theEmbeddedDataSpecification)).toBeNull();
...
test("casts over an instance of LevelType", () => {
  const theLevelType = TestCommonJsonization.loadMinimalLevelType();

  expect(AasTypes.isHasSemantics(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asHasSemantics(theLevelType)).toBeNull();

  expect(AasTypes.isExtension(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asExtension(theLevelType)).toBeNull();

  expect(AasTypes.isHasExtensions(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asHasExtensions(theLevelType)).toBeNull();

  expect(AasTypes.isReferable(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asReferable(theLevelType)).toBeNull();

  expect(AasTypes.isIdentifiable(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asIdentifiable(theLevelType)).toBeNull();

  expect(AasTypes.isHasKind(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theLevelType)).toBeNull();

  expect(AasTypes.isHasDataSpecification(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asHasDataSpecification(theLevelType)).toBeNull();

  expect(AasTypes.isAdministrativeInformation(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asAdministrativeInformation(theLevelType)).toBeNull();

  expect(AasTypes.isQualifiable(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asQualifiable(theLevelType)).toBeNull();

  expect(AasTypes.isQualifier(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asQualifier(theLevelType)).toBeNull();

  expect(AasTypes.isAssetAdministrationShell(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asAssetAdministrationShell(theLevelType)).toBeNull();

  expect(AasTypes.isAssetInformation(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asAssetInformation(theLevelType)).toBeNull();

  expect(AasTypes.isResource(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asResource(theLevelType)).toBeNull();

  expect(AasTypes.isSpecificAssetId(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asSpecificAssetId(theLevelType)).toBeNull();

  expect(AasTypes.isSubmodel(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asSubmodel(theLevelType)).toBeNull();

  expect(AasTypes.isSubmodelElement(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asSubmodelElement(theLevelType)).toBeNull();

  expect(AasTypes.isRelationshipElement(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asRelationshipElement(theLevelType)).toBeNull();

  expect(AasTypes.isSubmodelElementList(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asSubmodelElementList(theLevelType)).toBeNull();

  expect(AasTypes.isSubmodelElementCollection(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asSubmodelElementCollection(theLevelType)).toBeNull();

  expect(AasTypes.isDataElement(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asDataElement(theLevelType)).toBeNull();

  expect(AasTypes.isProperty(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asProperty(theLevelType)).toBeNull();

  expect(AasTypes.isMultiLanguageProperty(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asMultiLanguageProperty(theLevelType)).toBeNull();

  expect(AasTypes.isRange(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asRange(theLevelType)).toBeNull();

  expect(AasTypes.isReferenceElement(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asReferenceElement(theLevelType)).toBeNull();

  expect(AasTypes.isBlob(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asBlob(theLevelType)).toBeNull();

  expect(AasTypes.isFile(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asFile(theLevelType)).toBeNull();

  expect(AasTypes.isAnnotatedRelationshipElement(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asAnnotatedRelationshipElement(theLevelType)).toBeNull();

  expect(AasTypes.isEntity(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asEntity(theLevelType)).toBeNull();

  expect(AasTypes.isEventPayload(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asEventPayload(theLevelType)).toBeNull();

  expect(AasTypes.isEventElement(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asEventElement(theLevelType)).toBeNull();

  expect(AasTypes.isBasicEventElement(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asBasicEventElement(theLevelType)).toBeNull();

  expect(AasTypes.isOperation(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asOperation(theLevelType)).toBeNull();

  expect(AasTypes.isOperationVariable(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asOperationVariable(theLevelType)).toBeNull();

  expect(AasTypes.isCapability(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asCapability(theLevelType)).toBeNull();

  expect(AasTypes.isConceptDescription(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asConceptDescription(theLevelType)).toBeNull();

  expect(AasTypes.isReference(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asReference(theLevelType)).toBeNull();

  expect(AasTypes.isKey(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asKey(theLevelType)).toBeNull();

  expect(AasTypes.isAbstractLangString(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theLevelType)).toBeNull();

  expect(AasTypes.isLangStringNameType(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theLevelType)).toBeNull();

  expect(AasTypes.isLangStringTextType(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theLevelType)).toBeNull();

  expect(AasTypes.isEnvironment(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asEnvironment(theLevelType)).toBeNull();

  expect(AasTypes.isDataSpecificationContent(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asDataSpecificationContent(theLevelType)).toBeNull();

  expect(AasTypes.isEmbeddedDataSpecification(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asEmbeddedDataSpecification(theLevelType)).toBeNull();

  expect(AasTypes.isLevelType(theLevelType)).toStrictEqual(true);
  expect(AasTypes.asLevelType(theLevelType)).toStrictEqual(theLevelType);

  expect(AasTypes.isValueReferencePair(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asValueReferencePair(theLevelType)).toBeNull();

  expect(AasTypes.isValueList(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asValueList(theLevelType)).toBeNull();

  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theLevelType)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theLevelType)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theLevelType)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theLevelType)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theLevelType)).toBeNull();

  expect(AasTypes.isDataSpecificationIec61360(theLevelType)).toStrictEqual(false);
  expect(AasTypes.asDataSpecificationIec61360(theLevelType)).toBeNull();
});
...
test("casts over an instance of ValueReferencePair", () => {
  ...
  expect(AasTypes.isAbstractLangString(theValueReferencePair)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theValueReferencePair)).toBeNull();

  expect(AasTypes.isLangStringNameType(theValueReferencePair)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theValueReferencePair)).toBeNull();

  expect(AasTypes.isLangStringTextType(theValueReferencePair)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theValueReferencePair)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theValueReferencePair)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theValueReferencePair)).toBeNull();
  ...
  expect(AasTypes.asLangStringShortNameTypeIec61360(theValueReferencePair)).toBeNull();

  expect(
    AasTypes.isLangStringDefinitionTypeIec61360(theValueReferencePair)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theValueReferencePair)).toBeNull();
...
test("casts over an instance of ValueList", () => {
  ...
  expect(AasTypes.isAbstractLangString(theValueList)).toStrictEqual(false);
  expect(AasTypes.asAbstractLangString(theValueList)).toBeNull();

  expect(AasTypes.isLangStringNameType(theValueList)).toStrictEqual(false);
  expect(AasTypes.asLangStringNameType(theValueList)).toBeNull();

  expect(AasTypes.isLangStringTextType(theValueList)).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theValueList)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theValueList)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theValueList)).toBeNull();
  ...
  expect(AasTypes.isLangStringPreferredNameTypeIec61360(theValueList)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringPreferredNameTypeIec61360(theValueList)).toBeNull();

  expect(AasTypes.isLangStringShortNameTypeIec61360(theValueList)).toStrictEqual(false);
  expect(AasTypes.asLangStringShortNameTypeIec61360(theValueList)).toBeNull();

  expect(AasTypes.isLangStringDefinitionTypeIec61360(theValueList)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringDefinitionTypeIec61360(theValueList)).toBeNull();
...
test("casts over an instance of LangStringPreferredNameTypeIec61360", () => {
  ...
  expect(AasTypes.isHasSemantics(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asHasSemantics(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isExtension(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asExtension(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isHasExtensions(theLangStringPreferredNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asHasExtensions(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isReferable(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asReferable(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isIdentifiable(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asIdentifiable(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isHasKind(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asHasKind(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isQualifiable(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asQualifiable(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isQualifier(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asQualifier(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isResource(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asResource(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isSpecificAssetId(theLangStringPreferredNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asSpecificAssetId(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isSubmodel(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asSubmodel(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isSubmodelElement(theLangStringPreferredNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asSubmodelElement(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isDataElement(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asDataElement(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isProperty(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asProperty(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isRange(theLangStringPreferredNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asRange(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isBlob(theLangStringPreferredNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asBlob(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isFile(theLangStringPreferredNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asFile(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isEntity(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEntity(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isEventPayload(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEventPayload(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isEventElement(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEventElement(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isOperation(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asOperation(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isCapability(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asCapability(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isReference(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asReference(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(AasTypes.isKey(theLangStringPreferredNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asKey(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isEnvironment(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEnvironment(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asLevelType(theLangStringPreferredNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isValueList(theLangStringPreferredNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asValueList(theLangStringPreferredNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isLangStringPreferredNameTypeIec61360(
      theLangStringPreferredNameTypeIec61360
    )
  ).toStrictEqual(true);
  expect(
    AasTypes.asLangStringPreferredNameTypeIec61360(
      theLangStringPreferredNameTypeIec61360
    )
  ).toStrictEqual(theLangStringPreferredNameTypeIec61360);
...
test("casts over an instance of LangStringShortNameTypeIec61360", () => {
  ...
  expect(AasTypes.isHasSemantics(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asHasSemantics(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isExtension(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asExtension(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isHasExtensions(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asHasExtensions(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isReferable(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asReferable(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isIdentifiable(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asIdentifiable(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isHasKind(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theLangStringShortNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isQualifiable(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asQualifiable(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isQualifier(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asQualifier(theLangStringShortNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isAssetInformation(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asAssetInformation(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isResource(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asResource(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isSpecificAssetId(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asSpecificAssetId(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isSubmodel(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asSubmodel(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isSubmodelElement(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asSubmodelElement(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isRelationshipElement(theLangStringShortNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asRelationshipElement(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isSubmodelElementList(theLangStringShortNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asSubmodelElementList(theLangStringShortNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isDataElement(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asDataElement(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isProperty(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asProperty(theLangStringShortNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isRange(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asRange(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isReferenceElement(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asReferenceElement(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isBlob(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asBlob(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isFile(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asFile(theLangStringShortNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isEntity(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asEntity(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isEventPayload(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEventPayload(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isEventElement(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEventElement(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isBasicEventElement(theLangStringShortNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asBasicEventElement(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isOperation(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asOperation(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isOperationVariable(theLangStringShortNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asOperationVariable(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isCapability(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asCapability(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isConceptDescription(theLangStringShortNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asConceptDescription(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isReference(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asReference(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isKey(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asKey(theLangStringShortNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.asLangStringNameType(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isLangStringTextType(theLangStringShortNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isEnvironment(theLangStringShortNameTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEnvironment(theLangStringShortNameTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(
    AasTypes.isValueReferencePair(theLangStringShortNameTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asValueReferencePair(theLangStringShortNameTypeIec61360)).toBeNull();

  expect(AasTypes.isValueList(theLangStringShortNameTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asValueList(theLangStringShortNameTypeIec61360)).toBeNull();
...
test("casts over an instance of LangStringDefinitionTypeIec61360", () => {
  ...
  expect(AasTypes.isHasSemantics(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asHasSemantics(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isExtension(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asExtension(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isHasExtensions(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asHasExtensions(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isReferable(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asReferable(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isIdentifiable(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asIdentifiable(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isHasKind(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asHasKind(theLangStringDefinitionTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isQualifiable(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asQualifiable(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isQualifier(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asQualifier(theLangStringDefinitionTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.asAssetInformation(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isResource(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asResource(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isSpecificAssetId(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asSpecificAssetId(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isSubmodel(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asSubmodel(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isSubmodelElement(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asSubmodelElement(theLangStringDefinitionTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isDataElement(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asDataElement(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isProperty(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asProperty(theLangStringDefinitionTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isRange(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asRange(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(
    AasTypes.isReferenceElement(theLangStringDefinitionTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asReferenceElement(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isBlob(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asBlob(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isFile(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asFile(theLangStringDefinitionTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isEntity(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asEntity(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isEventPayload(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEventPayload(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isEventElement(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEventElement(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(
    AasTypes.isBasicEventElement(theLangStringDefinitionTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asBasicEventElement(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isOperation(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asOperation(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(
    AasTypes.isOperationVariable(theLangStringDefinitionTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asOperationVariable(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isCapability(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asCapability(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(
    AasTypes.isConceptDescription(theLangStringDefinitionTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asConceptDescription(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isReference(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asReference(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isKey(theLangStringDefinitionTypeIec61360)).toStrictEqual(false);
  expect(AasTypes.asKey(theLangStringDefinitionTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.asLangStringNameType(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(
    AasTypes.isLangStringTextType(theLangStringDefinitionTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asLangStringTextType(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isEnvironment(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asEnvironment(theLangStringDefinitionTypeIec61360)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asLevelType(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(
    AasTypes.isValueReferencePair(theLangStringDefinitionTypeIec61360)
  ).toStrictEqual(false);
  expect(AasTypes.asValueReferencePair(theLangStringDefinitionTypeIec61360)).toBeNull();

  expect(AasTypes.isValueList(theLangStringDefinitionTypeIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asValueList(theLangStringDefinitionTypeIec61360)).toBeNull();
...
test("casts over an instance of DataSpecificationIec61360", () => {
  ...
  expect(AasTypes.isAbstractLangString(theDataSpecificationIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asAbstractLangString(theDataSpecificationIec61360)).toBeNull();

  expect(AasTypes.isLangStringNameType(theDataSpecificationIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringNameType(theDataSpecificationIec61360)).toBeNull();

  expect(AasTypes.isLangStringTextType(theDataSpecificationIec61360)).toStrictEqual(
    false
  );
  expect(AasTypes.asLangStringTextType(theDataSpecificationIec61360)).toBeNull();
  ...
  expect(AasTypes.isLevelType(theDataSpecificationIec61360)).toStrictEqual(false);
  expect(AasTypes.asLevelType(theDataSpecificationIec61360)).toBeNull();
