...
// dev_scripts/test_codegen/generate_test_for_type_matching.py
...
const THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360 =
  TestCommonJsonization.loadMinimalLangStringPreferredNameTypeIec61360();

const THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360 =
  TestCommonJsonization.loadMinimalLangStringShortNameTypeIec61360();

const THE_LANG_STRING_DEFINITION_TYPE_IEC_61360 =
...
test("type matches for Extension", () => {
  ...
  expect(AasTypes.typesMatch(THE_EXTENSION, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_EXTENSION, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_EXTENSION, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_EXTENSION, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_EXTENSION, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_EXTENSION, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for AdministrativeInformation", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_ADMINISTRATIVE_INFORMATION, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_ADMINISTRATIVE_INFORMATION, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_ADMINISTRATIVE_INFORMATION, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
...
test("type matches for Qualifier", () => {
  ...
  expect(AasTypes.typesMatch(THE_QUALIFIER, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_QUALIFIER, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_QUALIFIER, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_QUALIFIER, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_QUALIFIER, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_QUALIFIER, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for AssetAdministrationShell", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_ASSET_ADMINISTRATION_SHELL, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_ASSET_ADMINISTRATION_SHELL, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_ASSET_ADMINISTRATION_SHELL, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
...
test("type matches for AssetInformation", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_ASSET_INFORMATION, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_ASSET_INFORMATION, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_ASSET_INFORMATION, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for Resource", () => {
  ...
  expect(AasTypes.typesMatch(THE_RESOURCE, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_RESOURCE, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_RESOURCE, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_RESOURCE, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_RESOURCE, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_RESOURCE, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for SpecificAssetId", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_SPECIFIC_ASSET_ID, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_SPECIFIC_ASSET_ID, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_SPECIFIC_ASSET_ID, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for Submodel", () => {
  ...
  expect(AasTypes.typesMatch(THE_SUBMODEL, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_SUBMODEL, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_SUBMODEL, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_SUBMODEL, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_SUBMODEL, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_SUBMODEL, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for RelationshipElement", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_RELATIONSHIP_ELEMENT, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_RELATIONSHIP_ELEMENT, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_RELATIONSHIP_ELEMENT, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for SubmodelElementList", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_SUBMODEL_ELEMENT_LIST, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_SUBMODEL_ELEMENT_LIST, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_SUBMODEL_ELEMENT_LIST, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for SubmodelElementCollection", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_SUBMODEL_ELEMENT_COLLECTION, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_SUBMODEL_ELEMENT_COLLECTION, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_SUBMODEL_ELEMENT_COLLECTION, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
...
test("type matches for Property", () => {
  ...
  expect(AasTypes.typesMatch(THE_PROPERTY, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_PROPERTY, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_PROPERTY, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_PROPERTY, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_PROPERTY, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_PROPERTY, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for MultiLanguageProperty", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_MULTI_LANGUAGE_PROPERTY, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_MULTI_LANGUAGE_PROPERTY, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_MULTI_LANGUAGE_PROPERTY, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
...
test("type matches for Range", () => {
  ...
  expect(AasTypes.typesMatch(THE_RANGE, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_RANGE, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_RANGE, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_RANGE, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_RANGE, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_RANGE, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for ReferenceElement", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_REFERENCE_ELEMENT, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_REFERENCE_ELEMENT, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_REFERENCE_ELEMENT, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for Blob", () => {
  ...
  expect(AasTypes.typesMatch(THE_BLOB, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_BLOB, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_BLOB, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_BLOB, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_BLOB, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_BLOB, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for File", () => {
  ...
  expect(AasTypes.typesMatch(THE_FILE, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_FILE, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_FILE, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_FILE, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_FILE, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_FILE, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for AnnotatedRelationshipElement", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_ANNOTATED_RELATIONSHIP_ELEMENT, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_ANNOTATED_RELATIONSHIP_ELEMENT, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_ANNOTATED_RELATIONSHIP_ELEMENT, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
...
test("type matches for Entity", () => {
  ...
  expect(AasTypes.typesMatch(THE_ENTITY, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_ENTITY, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_ENTITY, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_ENTITY, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_ENTITY, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_ENTITY, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for EventPayload", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_EVENT_PAYLOAD, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_EVENT_PAYLOAD, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_EVENT_PAYLOAD, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_EVENT_PAYLOAD, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_EVENT_PAYLOAD, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for BasicEventElement", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_BASIC_EVENT_ELEMENT, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_BASIC_EVENT_ELEMENT, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_BASIC_EVENT_ELEMENT, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for Operation", () => {
  ...
  expect(AasTypes.typesMatch(THE_OPERATION, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_OPERATION, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_OPERATION, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_OPERATION, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_OPERATION, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_OPERATION, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for OperationVariable", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_OPERATION_VARIABLE, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_OPERATION_VARIABLE, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_OPERATION_VARIABLE, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for Capability", () => {
  ...
  expect(AasTypes.typesMatch(THE_CAPABILITY, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_CAPABILITY, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_CAPABILITY, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_CAPABILITY, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_CAPABILITY, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_CAPABILITY, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for ConceptDescription", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_CONCEPT_DESCRIPTION, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_CONCEPT_DESCRIPTION, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_CONCEPT_DESCRIPTION, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for Reference", () => {
  ...
  expect(AasTypes.typesMatch(THE_REFERENCE, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_REFERENCE, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_REFERENCE, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_REFERENCE, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_REFERENCE, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_REFERENCE, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for Key", () => {
  ...
  expect(AasTypes.typesMatch(THE_KEY, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_KEY, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_KEY, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_KEY, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_KEY, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_KEY, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for LangStringNameType", () => {
  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_EXTENSION)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_ADMINISTRATIVE_INFORMATION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_QUALIFIER)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_ASSET_ADMINISTRATION_SHELL)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_ASSET_INFORMATION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_RESOURCE)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_SPECIFIC_ASSET_ID)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_SUBMODEL)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_RELATIONSHIP_ELEMENT)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_SUBMODEL_ELEMENT_LIST)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_SUBMODEL_ELEMENT_COLLECTION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_PROPERTY)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_MULTI_LANGUAGE_PROPERTY)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_RANGE)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_REFERENCE_ELEMENT)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_BLOB)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_FILE)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_ANNOTATED_RELATIONSHIP_ELEMENT)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_ENTITY)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_EVENT_PAYLOAD)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_BASIC_EVENT_ELEMENT)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_OPERATION)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_OPERATION_VARIABLE)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_CAPABILITY)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_CONCEPT_DESCRIPTION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_REFERENCE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_KEY)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(true);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_ENVIRONMENT)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_EMBEDDED_DATA_SPECIFICATION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_VALUE_REFERENCE_PAIR)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_VALUE_LIST)).toStrictEqual(
    false
  );
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_NAME_TYPE, THE_DATA_SPECIFICATION_IEC_61360)
  ).toStrictEqual(false);
});

test("type matches for LangStringTextType", () => {
  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_EXTENSION)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_ADMINISTRATIVE_INFORMATION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_QUALIFIER)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_ASSET_ADMINISTRATION_SHELL)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_ASSET_INFORMATION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_RESOURCE)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_SPECIFIC_ASSET_ID)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_SUBMODEL)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_RELATIONSHIP_ELEMENT)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_SUBMODEL_ELEMENT_LIST)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_SUBMODEL_ELEMENT_COLLECTION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_PROPERTY)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_MULTI_LANGUAGE_PROPERTY)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_RANGE)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_REFERENCE_ELEMENT)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_BLOB)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_FILE)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_ANNOTATED_RELATIONSHIP_ELEMENT)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_ENTITY)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_EVENT_PAYLOAD)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_BASIC_EVENT_ELEMENT)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_OPERATION)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_OPERATION_VARIABLE)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_CAPABILITY)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_CONCEPT_DESCRIPTION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_REFERENCE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_KEY)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(true);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_ENVIRONMENT)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_EMBEDDED_DATA_SPECIFICATION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_VALUE_REFERENCE_PAIR)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_VALUE_LIST)).toStrictEqual(
    false
  );
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_TEXT_TYPE, THE_DATA_SPECIFICATION_IEC_61360)
  ).toStrictEqual(false);
});
...
test("type matches for Environment", () => {
  ...
  expect(AasTypes.typesMatch(THE_ENVIRONMENT, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_ENVIRONMENT, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_ENVIRONMENT, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_ENVIRONMENT, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_ENVIRONMENT, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_ENVIRONMENT, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for EmbeddedDataSpecification", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_EMBEDDED_DATA_SPECIFICATION, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_EMBEDDED_DATA_SPECIFICATION, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_EMBEDDED_DATA_SPECIFICATION, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
...
test("type matches for LevelType", () => {
  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_EXTENSION)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_ADMINISTRATIVE_INFORMATION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_QUALIFIER)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_ASSET_ADMINISTRATION_SHELL)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_ASSET_INFORMATION)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_RESOURCE)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_SPECIFIC_ASSET_ID)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_SUBMODEL)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_RELATIONSHIP_ELEMENT)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_SUBMODEL_ELEMENT_LIST)).toStrictEqual(
    false
  );

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_SUBMODEL_ELEMENT_COLLECTION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_PROPERTY)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_MULTI_LANGUAGE_PROPERTY)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_RANGE)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_REFERENCE_ELEMENT)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_BLOB)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_FILE)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_ANNOTATED_RELATIONSHIP_ELEMENT)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_ENTITY)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_EVENT_PAYLOAD)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_BASIC_EVENT_ELEMENT)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_OPERATION)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_OPERATION_VARIABLE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_CAPABILITY)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_CONCEPT_DESCRIPTION)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_REFERENCE)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_KEY)).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_ENVIRONMENT)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_EMBEDDED_DATA_SPECIFICATION)
  ).toStrictEqual(false);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_LEVEL_TYPE)).toStrictEqual(true);

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_VALUE_REFERENCE_PAIR)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_LEVEL_TYPE, THE_VALUE_LIST)).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LEVEL_TYPE, THE_DATA_SPECIFICATION_IEC_61360)
  ).toStrictEqual(false);
});
...
test("type matches for ValueReferencePair", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_VALUE_REFERENCE_PAIR, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_VALUE_REFERENCE_PAIR, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(AasTypes.typesMatch(THE_VALUE_REFERENCE_PAIR, THE_LEVEL_TYPE)).toStrictEqual(
    false
  );
...
test("type matches for ValueList", () => {
  ...
  expect(AasTypes.typesMatch(THE_VALUE_LIST, THE_LANG_STRING_NAME_TYPE)).toStrictEqual(
    false
  );

  expect(AasTypes.typesMatch(THE_VALUE_LIST, THE_LANG_STRING_TEXT_TYPE)).toStrictEqual(
    false
  );
  ...
  expect(AasTypes.typesMatch(THE_VALUE_LIST, THE_LEVEL_TYPE)).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_VALUE_LIST, THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_VALUE_LIST, THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_VALUE_LIST, THE_LANG_STRING_DEFINITION_TYPE_IEC_61360)
  ).toStrictEqual(false);
...
test("type matches for LangStringPreferredNameTypeIec61360", () => {
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_EXTENSION)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_QUALIFIER)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_RESOURCE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_SUBMODEL)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_PROPERTY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_RANGE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_BLOB)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_FILE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_ENTITY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_OPERATION)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_CAPABILITY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_REFERENCE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_KEY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_ENVIRONMENT)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360, THE_VALUE_LIST)
  ).toStrictEqual(false);
...
test("type matches for LangStringShortNameTypeIec61360", () => {
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_EXTENSION)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_QUALIFIER)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_RESOURCE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_SUBMODEL)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_PROPERTY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_RANGE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_BLOB)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_FILE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_ENTITY)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_EVENT_PAYLOAD)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_OPERATION)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_CAPABILITY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_REFERENCE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_KEY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_ENVIRONMENT)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_SHORT_NAME_TYPE_IEC_61360, THE_VALUE_LIST)
  ).toStrictEqual(false);
...
test("type matches for LangStringDefinitionTypeIec61360", () => {
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_EXTENSION)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_QUALIFIER)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_RESOURCE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_SUBMODEL)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_PROPERTY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_RANGE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_BLOB)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_FILE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_ENTITY)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_EVENT_PAYLOAD)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_OPERATION)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_CAPABILITY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_REFERENCE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_KEY)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_ENVIRONMENT)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_LANG_STRING_DEFINITION_TYPE_IEC_61360, THE_VALUE_LIST)
  ).toStrictEqual(false);
...
test("type matches for DataSpecificationIec61360", () => {
  ...
  expect(
    AasTypes.typesMatch(THE_DATA_SPECIFICATION_IEC_61360, THE_LANG_STRING_NAME_TYPE)
  ).toStrictEqual(false);

  expect(
    AasTypes.typesMatch(THE_DATA_SPECIFICATION_IEC_61360, THE_LANG_STRING_TEXT_TYPE)
  ).toStrictEqual(false);
  ...
  expect(
    AasTypes.typesMatch(THE_DATA_SPECIFICATION_IEC_61360, THE_LEVEL_TYPE)
  ).toStrictEqual(false);
