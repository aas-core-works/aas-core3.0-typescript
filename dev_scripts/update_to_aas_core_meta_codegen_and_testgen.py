...
def _copy_code_from_aas_core_codegen(
    ...
    source_dir = (
        ...
        / "dev/test_data/typescript/test_main/aas_core_meta.v3/expected_output"
    )
...
def _run_tests_and_rerecord(our_repo: pathlib.Path) -> None:
    ...
    env = os.environ.copy()
    env["AAS_CORE3_0_TYPESCRIPT_TEST_DATA_DIR"] = str(our_repo / "test_data")
    env["AAS_CORE3_0_TYPESCRIPT_RECORD_MODE"] = "true"
